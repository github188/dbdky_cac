/* soapCAGWebServicePortSoap12Service.h
...
#ifndef soapCAGWebServicePortSoap12Service_H
#define soapCAGWebServicePortSoap12Service_H
#include "soapH.h"
class SOAP_CMAC CAGWebServicePortSoap12Service : public soap
{ public:
	/// Constructor
	CAGWebServicePortSoap12Service();
	/// Constructor with copy of another engine state
	CAGWebServicePortSoap12Service(const struct soap&);
	/// Constructor with engine input+output mode control
	CAGWebServicePortSoap12Service(soap_mode iomode);
	/// Constructor with engine input and output mode control
	CAGWebServicePortSoap12Service(soap_mode imode, soap_mode omode);
	/// Destructor, also frees all deserialized data
	virtual ~CAGWebServicePortSoap12Service();
	/// Delete all deserialized data (uses soap_destroy and soap_end)
	virtual	void destroy();
	/// Initializer used by constructor
	virtual	void CAGWebServicePortSoap12Service_init(soap_mode imode, soap_mode omode);
	/// Create a copy
	virtual	CAGWebServicePortSoap12Service *copy() SOAP_PURE_VIRTUAL;
