...
/* Operation wrapper: */
struct __ns2__uploadCMAHeartbeatInfo
{
public:
...
/* Operation wrapper: */
struct __ns3__uploadCMAHeartbeatInfo
{
public:
	_ns1__uploadCMAHeartbeatInfo *ns1__uploadCMAHeartbeatInfo;	/* optional element of type ns1:uploadCMAHeartbeatInfo */
};
